...
| 5 | [Payment Integration](./05-payment-integration.md) | PayFast/Ozow integration, escrow flow, commission calculation, and payout cycle |
...
| 7 | [Booking & Scheduling Engine](./07-booking-and-scheduling.md) | Availability management, booking flow, conflict resolution, and calendar sync |
